...
<head>
    ...
    <title>Immobilier - Lebonplan</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="immobilier.php" class="active" aria-current="page">Immobilier</a>
    ...
    <header>
        <div class="header-bar">
            <h1 class="categorie-title">Immobilier</h1>
        </div>
    </header>
    
    <main class="content-container">
        <h2 class="section-title">Annonces Immobilières</h2>
        <p>Retrouvez ici toutes les annonces disponibles dans la catégorie Immobilier.</p>
