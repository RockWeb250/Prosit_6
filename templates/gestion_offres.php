...
<body>
    ...
    <div class="cookie-box">
        ...
        <p style="text-align: center">
            <span><a href="#recherche" class="inscription-btn">Rechercher une Offre</a></span>
        </p>
        <p>
            <span><a href="#creer" class="inscription-btn">Créer une Offre</a></span>
        </p>
        <p>
            <span><a href="#supprimer" class="inscription-btn">Supprimer une Offre</a></span>
        </p>
        <p>
            <span><a href="#modifier" class="inscription-btn">Modifier une Offre</a></span>
        </p>
    </div>

    <!-- Recherche -->
    <div id="recherche" style="margin-top: 40px;">
        <h3 class="categorie-title">Rechercher une Offre</h3>
