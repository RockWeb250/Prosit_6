...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="maison.php" class="active" aria-current="page">Maison</a>
    ...
    <header>
        <div class="header-bar">
            <h1 class="categorie-title">Maison</h1>
        </div>
    </header>
    
    <main class="content-container">
        <h2 class="section-title">Annonces Maison</h2>
        <p>Retrouvez ici toutes les annonces disponibles dans la catégorie Maison.</p>
