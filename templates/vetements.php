...
<head>
    ...
    <title>Vêtements - Lebonplan</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="vetements.php" class="active" aria-current="page">Vêtements</a>
    ...
    <header>
        <div class="header-bar">
            <h1 class="categorie-title">Vêtements</h1>
        </div>
    </header>
    
    <main class="content-container">
        <h2 class="section-title">Annonces Vêtements</h2>
        <p>Retrouvez ici toutes les annonces disponibles dans la catégorie Vêtements.</p>
