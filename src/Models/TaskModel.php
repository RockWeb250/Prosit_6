...
class TaskModel extends Model {
    ...
    public function getAllTasks() {
        ...
        $tasks = $this->connection->getAllRecords();
        return $tasks;
    }
    ...
    public function getTask($id) {
        ...
        $task = $this->connection->getRecord($id);
        return $task;
    }
    ...
    public function checkTask($id) {
        ...
        $record = $this->connection->getRecord($id);
        // Check if the task exists, if not, return false
        if (!$record) {
            return false;
        }
        // The task is updated with the status 'done'
        return $this->updateTask($id, $record['task'], self::DONE_STATUS);
    }
    ...
    public function uncheckTask($id) {
        ...
        return $this->updateTask($id, $record['task'], self::TODO_STATUS);
    }
