...
<body>
    ...
    <main>
        <section class="job-details">
            <h2>Stage - Administrateur Système et Réseau H/F</h2>
            <p>Entreprise : BM | Localisation : Pornichet</p>
            <p>Publié le : 28/01/2025 | Réf : 12371-44</p>
            <h3>Résumé de l'offre :</h3>
            <div class="resume-offre">
                <span>3 mois</span>
                <span>Bac +2, Bac +3</span>
        ...
        <section class="formulaire">
            <div class="form-container">
                <form action="../cv.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="cv-upload" onclick="document.getElementById('cv').click();"> Ajouter mon CV
                        <input type="file" id="cv" name="cv" accept=".pdf,.doc,.docx,.rtf,.jpg,.png"
                            style="display: none;">
                    </div>
