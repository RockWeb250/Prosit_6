...
<head>
    ...
    <title>Multimédia - Lebonplan</title>
...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="multimedia.php" class="active" aria-current="page">Multimédia</a>
    ...
    <header>
        <div class="header-bar">
            <h1 class="categorie-title">Multimédia</h1>
        </div>
    </header>
    
    <main class="content-container">
        <h2 class="section-title">Annonces Multimédia</h2>
        <p>Retrouvez ici toutes les annonces disponibles dans la catégorie Multimédia.</p>
